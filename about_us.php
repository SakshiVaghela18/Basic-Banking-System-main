...
<head>
    ...
    <title>About us - Principle Bank</title>
...
<body style="background-color:#5A5A5A;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Sakshi Vaghela</h1>
            <p style="color:gray;"><b>Intern at Sparks Foundation <br> Pandit Deendayal Energy University, Gandhinagar</b></p>
    </center>
